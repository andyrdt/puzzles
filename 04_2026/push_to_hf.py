...
Usage:
    python 04_2026/push_to_hf.py --local_dir 04_2026/puzzle1a/checkpoints --repo_id andyrdt/04_2026_puzzle_1a
    python 04_2026/push_to_hf.py --local_dir 04_2026/puzzle1b/checkpoints --repo_id andyrdt/04_2026_puzzle_1b
"""
...
def main():
    ...
    p.add_argument("--repo_id", type=str, required=True, help="HuggingFace repo id, e.g. andyrdt/04_2026_puzzle_1a")
